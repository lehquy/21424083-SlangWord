...
public class Menu extends JFrame implements ActionListener {
	...
	Menu() {
		...
		// A Grid
		btn1 = new JButton("1. Danh sach Slang word");
		btn1.addActionListener(this);
		btn1.setFont(new Font("NewellsHand", Font.PLAIN, 14));
		btn1.setFocusable(false);

		btn2 = new JButton("2. Tim Slang word");
		btn2.addActionListener(this);
		btn2.setFont(new Font("NewellsHand", Font.PLAIN, 14));
		btn2.setFocusable(false);

		btn3 = new JButton("3. Them slang word");
		...
		btn5 = new JButton("5. Lich su");
		btn5.addActionListener(this);
		btn5.setFont(new Font("Gill Sans MT", Font.PLAIN, 14));
		btn5.setFocusable(false);

		btn6 = new JButton("6. Xoa Slang Word");
		...
		Dimension size2 = new Dimension(800, 600);
